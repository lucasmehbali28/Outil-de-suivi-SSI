                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Formulaire pour intégrer une nouvelle catégorie de règles</li>
                        </ol>
                        <div class="row">
                            <form class="custom_display" id="form_crud" action="formulaire_categorie.php" method="post">
                                <div></div>
                                <div>
                    ...
                    <?php /************************ Si aucune connexion à la base de donnée, redirection vers la page d'erreur du serveur ******************************/
                                        ...
                                        if(isset($_POST['submit'])){
                                            ...
                                            // Vérification si la catégorie est numérique
                                            if($isValid && is_numeric($catname) ){
                                            $isValid = false;
                                            $error_message = "Une catégorie ne peut être un chiffre ou un nombre.";
                                            echo '<p class="error">'.$error_message.'</p>';
                                            }
                                            
                                                // Enregistrement dans la base de données
                                                if($isValid){
                                                    $insertSQL = "INSERT INTO categorie(nom_categorie) values(?)";
                                                    $stmt = $mysqli->prepare($insertSQL);
                                                    $stmt->bind_param("s",$catname);
                                                    $stmt->execute();
                                                    $stmt->close();
                                            
                                                $success_message = "La catégorie a été créée avec succès. Vous allez être redirigé vers la page d'accueil dans quelques secondes.";
