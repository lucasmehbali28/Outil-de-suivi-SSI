            ...
            <div id="layoutSidenav_content">
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Formulaire pour créer un plan d'action</li>
                        </ol>
                        <div class="row">
                            <form class="custom_display" id="form_crud" action="formulaire_planaction.php" method="post">
                                <div></div>
                                <div>
                                    <label for="planactionName">Nom du plan d'action :</label>
                                    <input type="text" id="planactionName" name="planactionName" required>

                                    <label for="description">Descriptif du plan d'action :</label>
                                    <input type="text" id="description" name="description" required>

                                    <label for="rule">Règle rattaché au plan d'action :</label>
                                    ...
                                    <label for="ticket">N° de ticket :</label>
                ...
                <?php /************************ Si aucune connexion à la base de donnée, redirection vers la page d'erreur du serveur ******************************/
                                        ...
                                        if(isset($_POST['submit'])){
                                            $planactionname = trim($_POST['planactionName']);
                                            ...
                                            if($planactionname == '' || $description == '' || $rule == '' || $ticket == '') {
                                            $isValid = false;
                                            ...
                                            echo '<p class="error">'.$error_message.'</p>';
                                                ...
                                                if($isValid){
                                                    $insertSQL = "INSERT INTO planaction (nom_planaction,descriptif_planaction,id_regle_planaction,id_ticket_planaction) values(?,?,?,?)";
                                                    $stmt = $mysqli->prepare($insertSQL);
                                                    $stmt->bind_param("ssss",$planactionname,$description,$rule,$ticket);
                                                    $stmt->execute();
                                                    $stmt->close();
                                            
                                                $success_message = "Le plan d'action a été créé avec succès. Vous allez être redirigé vers la page d'accueil dans quelques secondes.";
