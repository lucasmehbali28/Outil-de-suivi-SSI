                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Demande de modification d'action en recherchant un n° de ticket</li>
                        </ol>
                        <div class="row">
                            <form class="custom_display" id="form_crud" action="modifyactionbystatut.php" method="post">
                                <div></div>
                                <div>
                                  <?php $id = $_GET['id'];?>
                                  ...
                                  <label for="typeAction">Type d'action :</label>
                                    <select name="typeAction" id="typeAction" required>
                        ...
                        if (!$mysqli) {
                            ...
                            if (isset($_POST['submit'])) { /***************************** Vérification des champs si le formulaire est envoyé **********************************/
                                ...
                                if (empty($_POST['ticketNumber']) || empty($_POST['title']) || empty($_POST['dueDate']) || empty($_POST['frequency']) || empty($_POST['typeAction'])) {
                                    echo '<p class="error">Vous devez remplir tous les champs</p>' ;
                                }
                                if (date('Y-m-d') > htmlspecialchars($_POST['dueDate'])) {
                                    echo '<p class="error">Vous devez saisir une date d\'échéance supérieure à la date d\'aujourd\'hui</p>' ;
                                }  
                                else    {
                                    ...
                                    $typeAction = mysql_real_escape_string($_POST['typeAction']);
                                    ...
                                    $sqlUpdate = "
                                        ...
                                        SET     titre_action = '".$title."', 
                                                ...
                                                frequence_action = '".$frequency."'
                                        WHERE 
                                                id_ticket_action = '".$ticketNumber."'"; 

                                    mysqli_query($mysqli, $sqlUpdate);
                                    echo '<p class="success">La modification a été effectué !</p>' ;
