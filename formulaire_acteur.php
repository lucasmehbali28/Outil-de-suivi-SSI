            ...
            <div id="layoutSidenav_content">
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Formulaire pour créer un nouvelle acteur</li>
                        </ol>
                        <div class="row">
                            <form class="custom_display" id="form_crud" action="formulaire_acteur.php" method="post">
                                <div></div>
                                <div>
                                    ...
                                    <input type="texte" id="adress" name="adress" required>

                                    <label for="mail">Email :</label>
                                    <input type="email" id="mail" name="mail" pattern=".+@gers.fr" size="30" required>

                                    <label for="login">Login :</label>
                                    <input type="texte" id="login" name="login" required>

                                    <label for="password">Mot de passe :</label>
                                    <?/******  le pattern oblige une majuscule + un chiffre + minuscule + symbole et au minimum 8caractères ***********/?>
                                    <input type="password" id="password" name="password" pattern="(?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$" required>
                                    
                                    <label for="confirmPassword">Confirmation du Mot de passe :</label>
                                    <input type="password" id="confirmPassword" name="confirmPassword" pattern="(?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$" required>
                ...
                <?php /************************ Si aucune connexion à la base de donnée, redirection vers la page d'erreur du serveur ******************************/
                                        ...
                                        if(isset($_POST['submit'])){
                                            ...
                                            if($lname == '' || $fname == '' || $entite == '' || $site == ''|| $phone == '' || $email == '' || $adress == '' || $login == '' || $password == '' || $confirmpassword == ''){
                                            $isValid = false;
                                            ...
                                            if ($isValid && !filter_var($email, FILTER_VALIDATE_EMAIL)) {
                                                ...
                                                $success_message = "Le compte a été créé avec succès. Vous allez être redirigé vers la page d'accueil dans quelques secondes.";
