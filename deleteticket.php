            ...
            <div id="layoutSidenav_content">
                ...
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Vous allez :</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Supprimer une action dans la base de données</li>
                        </ol>
                        <div class="row">
                            <div class="col-12">
                            ...
                            $sqlDelete = "DELETE FROM action WHERE id_ticket_action = $id"; 
